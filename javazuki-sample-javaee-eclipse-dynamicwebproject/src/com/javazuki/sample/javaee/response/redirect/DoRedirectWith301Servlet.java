...
@WebServlet("/doRedirectWith301")
public class DoRedirectWith301Servlet extends HttpServlet {

  @Override protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    System.out.println("DoRedirect301Servlet doGet() started");
    ...
    // 通常はすぐにreturnする
    System.out.println("DoRedirect301Servlet doGet() ended");
  }
